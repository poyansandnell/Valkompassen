      ...
      <div className="container max-w-4xl mx-auto px-4 py-16 space-y-16">
        ...
        <section className="space-y-8 pt-8 border-t">
          ...
          <div className="space-y-4 text-muted-foreground">
            ...
            <p>
              Partier som ställer upp i valet men ännu inte nått 50%-tröskeln visas längre ner på resultatsidan 
            ...
            <Card>
              ...
              <CardContent className="text-muted-foreground">
                <p>
                  ...
                  ståndpunkt i vissa frågor. Vi arbetar löpande med att komplettera svaren. Partier som inte nått 50% 
